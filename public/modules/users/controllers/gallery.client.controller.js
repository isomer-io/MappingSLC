...
angular.module('users').controller('GalleryController', ['$scope', '$stateParams', '$location', 'AuthenticationService', 'UsersService', 'Projects', '$http', '$modal',
    ...
    //gallery slider
        ...
        var gallerySlider = function ( window ) {
            ...
            CBPGridGallery.prototype._init = function() {
                ...
                //this.ctrlPrev = this.el.querySelector( 'section.slideshow > nav > span.fa.fa-arrow-left' );
                //this.ctrlNext = this.el.querySelector( 'section.slideshow > nav > span.fa.fa-arrow-right' );
                //this.ctrlClose = this.el.querySelector( 'section.slideshow > nav > span.fa.fa-arrow--close' );
                // init masonry grid
                this._initMasonry();
                // init events
                this._initEvents();
        ...
        gallerySlider( window );



        //code for related stories gallery
